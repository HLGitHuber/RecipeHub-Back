...
namespace RecipeHub.Infrastructure.Migrations
{
    ...
    [Migration("20230908110030_ingredientsText_delete")]
    partial class ingredientsText_delete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeHub.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a4c612ea-7584-4bc6-a1fa-82ca5aca4039",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "a8ce56d6-6385-47e0-8dad-26ecf99663d4",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("RecipeHub.Domain.Role", null)
                        .WithMany()
